...
class OracleEpmUserInfoResourceTest {
    ...
    void get_happyPath_passesThroughAndProjectsEmail() throws Exception {
        ...
        String body = "{\n" +
                "  \"sub\": \"yosrixp@yahooinc.com\",\n" +
                "  \"preferred_username\": \"yosrixp@yahooinc.com\",\n" +
                "  \"name\": \"Yosri Amarneh\",\n" +
                "  \"given_name\": \"Yosri\",\n" +
                "  \"family_name\": \"Amarneh\"\n" +
                "}";
        ...
        assertEquals("yosrixp@yahooinc.com", entity.get("sub"));
        assertEquals("yosrixp@yahooinc.com", entity.get("preferred_username"));
